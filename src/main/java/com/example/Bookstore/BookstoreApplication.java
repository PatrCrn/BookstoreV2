...
public class BookstoreApplication {
	...
	public CommandLineRunner studentDemo(BookRepository bookRepository, CategoryRepository categoryRepository, UserRepository userRepository) {
		return (args) -> {
			...
			userRepository.save(new UserTable("patr74admin", "$2y$10$YTn3OO4lUwb3rz2vrJ2dA.RDNNMbRZlQww2Rkh9kISnA2JF5DvMZG", "patr74admin@hotmail.com", "ADMIN"));
			userRepository.save(new UserTable("patr74user", "$2y$10$6MYqXRHobELLjJChB2mcy.WeZAC3f6Wk0w3Z8Jt3Jlckvss8c.ZlK", "patr74user@hotmail.com", "USER"));
